...
#define NUMBER_TO_STRING_RE_CACHE_REASON_LIMIT 48
        ...
        Js::Var scriptSource)
    {
        ...
        bool createParserState = (loadScriptFlag & LoadScriptFlag_CreateParserState) == LoadScriptFlag_CreateParserState;
        ...
        if (createParserState)
        {
            Parser::BuildDeferredStubTree(parseTree, this->GetRecycler());
        }
